...
# t/01-parse.t
#
# This is meant *exclusively* to test the internal directive parser.
# Without directives working there's no need to do anything else.
#
# Not *even* combining with actions at this point. Just test that the given
# directives parse cleanly.
#
# Compiling comes later, and is broken into stages, in fact.
